// Script to standardize collection names (Batch 2)
...
// Collection mapping for batch 2
...
async function main() {
  try {
    ...
    if (result) {
      console.log('\nBatch 2 collection standardization completed successfully!');
    } else {
      console.log('\nBatch 2 collection standardization failed!');
    }
  } catch (error) {

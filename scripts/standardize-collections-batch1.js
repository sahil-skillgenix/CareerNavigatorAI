// Script to standardize collection names (Batch 1)
...
// Collection mapping for batch 1
...
async function standardizeCollections() {
  try {
    ...
    console.log('\nCollections after batch 1 processing:');
...
async function main() {
  try {
    ...
    if (result) {
      console.log('\nBatch 1 collection standardization completed successfully!');
    } else {
      console.log('\nBatch 1 collection standardization failed!');
    }
  } catch (error) {

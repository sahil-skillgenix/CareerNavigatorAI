 ...
 * 
 * Usage: DATABASE_URL=mongodb+srv://... node check-db-collections.js
 */
...
`;
      ...
      require('fs').writeFileSync('drop-unknown-collections.js', cleanupCode);
      console.log('\nCreated drop-unknown-collections.js script for removing unrecognized collections');
